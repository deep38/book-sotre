...
const navBarButtonStyle = { display: { xs: 'block', sm: 'block'}, "&:hover":{backgroundColor: {xs:alpha(theme.palette.common.black, 0.05)}, borderRadius: {xs:'5px'}},marginRight: {md:"10px"}, cursor: 'pointer',fontFamily: 'Josefin Sans', width: {xs: '100%',sm:'fit-content'}, boxSizing: {xs: 'border-box'}, padding: {xs: '5px'}, textAlign: 'center' };
